...
public abstract partial class Sensor : MonoBehaviour
{
	...
	public static Vector3 	magneticFieldUncalibrated  	{ get { return Value(Type.MagneticFieldUncalibrated); } } // [µT] (micro-Tesla)
	public static Vector3 	gameRotationVector 			{ get { return Value(Type.GameRotationVector); } } // [last three values of a quaternion]
	public static Vector3 	gyroscopeUncalibrated 		{ get { return Value(Type.GyroscopeUncalibrated); } } // [radians/second]
//	public static  ? significantMotion ?
	public static bool 		stepDetector 				{ get { return Value(Type.StepDetector).x > 0; } } // [true if step since last poll]
	public static int 		stepCounter 				{ get { return (int) Value(Type.StepCounter).x; } } // [int since last reboot]
	public static Vector3	geomagneticRotationVector 	{ get { return Value(Type.GeomagneticRotationVector); } } // [last three values of a quaternion]
	
	
	// helper functions
	[System.Obsolete ("Use Sensor.rotation instead.")]
	public static Quaternion rotationQuaternion	{ get { return Singleton.QuaternionFromRotationVector(rotationVector); } } 
	public static Quaternion rotation { get { return Singleton.QuaternionFromRotationVector(rotationVector); } } 
	...
	public Information[] sensors;
//	protected static readonly Information[] Sensors = new Information[Sensor.Count + 1];
	protected static Information[] Sensors { 
		get {
			return Singleton.sensors;
		}
	}
...
//#endif
	...
	protected virtual void SetSensorOn(Type sensorID)
	{
		Sensors[(int)sensorID].active = true;
	}
	
	protected virtual void SetSensorOff(Type sensorID)
	{
